								...
								'google_setting' => array(
									...
									'fields' => array(
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Directions API, Geocoding API, Maps JavaScript API and Static Maps API.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=maps-backend.googleapis.com,geocoding-backend.googleapis.com,directions-backend.googleapis.com,static-maps-backend.googleapis.com&keyType=CLIENT_SIDE&reusekey=true'),
