...
class w2dc_locations_manager {
	...
	public function validateLocations($level, &$errors) {
		...
		$validation->set_rules('map_coords_1[]', __('Latitude', 'W2DC'), 'numeric|greater_than[-90]|less_than[90]');
		$validation->set_rules('map_coords_2[]', __('Longitude', 'W2DC'), 'numeric|greater_than[-180]|less_than[180]');
